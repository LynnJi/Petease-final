...
<html>
    ...
    <body>
        ...
        <div class="container" id="content" style="height:100%">
            <div style="font-size: 20px;color:red;padding-top:50px;padding-bottom: 50px;">File uploading failed. Please check the file size or type.</div>
                <div><a href="./postarticle">Back forwards</a></div>
